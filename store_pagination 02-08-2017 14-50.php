                                ...
                                <div class="st_discription_wrap">
                                    ...
                                    foreach ($new_data as $data)
                                    {
                                        ...
                                        <div class="st_discription <?php echo $i ?>" id="<?php echo $i ?>">
                                            ...
                                            $class = $class . ' ' . $i;
                                            $coupontype = 'LC';
                                            $coupons .= '<div class="input_wrap"><input class="localcoupon" hide_data="' . $store_id . '" name="localcoupon' . $store_id . '" rel="dispdesc_' . $i . '" data_id="' . $i . '" coupontype="' . $coupontype . '" type="radio" value="' . base64_encode($data['localcoupons_id']) . '" '.$checked.' /><label>' . $data['localcoupons_name'] . '</label></div><br />';
                                            if ($j)
                                            {
                                            ?>
                                                </div>
